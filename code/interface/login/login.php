        ...
        <form method="POST" id="login_form" autocomplete="off"
            ...
            <div class="row">
                ...
                <div class="col-sm-<?php echo $loginFormColumnCount; ?>">
                    ...
                    <div class="form-group">
                        Available Login, use Small letters
                    <div class="form-group">
                        <b>1/-Username:</b> reception <b>Password:</b> demo
                    <div class="form-group">
                        <b>2/-Username:</b> doctor &nbsp&nbsp&nbsp&nbsp&nbsp<b>Password:</b> demo
                    </div>
                    <div class="form-group">
                        <label for="authUser" class="control-label text-right"><?php echo xlt('Username: reception or doctor'); ?></label>
                        <input type="text" class="form-control" id="authUser" name="authUser" placeholder="<?php echo xla('Username:'); ?>">
                    </div>
                    <div class="form-group">
                        <label for="clearPass" class="control-label text-right"><?php echo xlt('Password: demo'); ?></label>
