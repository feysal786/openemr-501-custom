...
// feysal exprement 
//$widgetButtonLink = "/interface/patient_file/transaction/add_transaction.php?title=LBT_AFC";
//$widgetButtonLink = "/interface/patient_file/encounter/load_form2.php?formname=LBFfertility";
$widgetButtonClass = "";
$linkMethod = "html";
$bodyClass = "";
...
/* feysal also L:1342 display:none
...
?>
                    <br/>
                    <div style='margin-left:10px;display:none' class='text'><img src='../../pic/ajax-loader.gif'/></div><br/>
                </div>
     </td>
    </tr>
...
?>
	...
	<!-- feysal to hid right column style="display:none" -->
    <div>
    <table>
    <tr>
    <td>
