<?php /* Smarty version 2.6.31, created on 2020-01-22 14:14:34
         compiled from /usr/share/nginx/html/demo/interface/forms/vitals/templates/vitals/general_new.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'xl', '/usr/share/nginx/html/demo/interface/forms/vitals/templates/vitals/general_new.html', 29, false),array('function', 'math', '/usr/share/nginx/html/demo/interface/forms/vitals/templates/vitals/general_new.html', 154, false),array('modifier', 'date_format', '/usr/share/nginx/html/demo/interface/forms/vitals/templates/vitals/general_new.html', 131, false),array('modifier', 'string_format', '/usr/share/nginx/html/demo/interface/forms/vitals/templates/vitals/general_new.html', 190, false),)), $this); ?>
<html>
<head>
...
?>
	...
	<?php if ($this->_tpl_vars['units_of_measurement'] == 4): ?><tr class="hide"><?php else: ?><tr><?php endif; ?>
		...
		<?php if ($this->_tpl_vars['units_of_measurement'] == 2): ?><td class="valuesunfocus"><?php else: ?><td class='currentvalues'><?php endif; ?>
                <input type="hidden" size='5' name='weight' id='weight_input' value="<?php if ($this->_tpl_vars['vitals']->get_weight() != 0): ?><?php echo $this->_tpl_vars['vitals']->get_weight(); ?>
...
<?php endif; ?></td>
	...
	<tr><td class="graph" id="respiration"><?php echo smarty_function_xl(array('t' => 'BSR'), $this);?>
</td><td><?php echo smarty_function_xl(array('t' => "mg/dl"), $this);?>
</td>
		<td class='currentvalues'><input type="text" size='5'
...
">
        <input type="hidden" class="editonly" id="cancel" value="<?php echo smarty_function_xl(array('t' => 'Cancle'), $this);?>
">
        </td>
</tr>
</table>
